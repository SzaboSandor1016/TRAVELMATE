 ...
 * An adapter for a [RecyclerView] containing the [RouteNode]s (the stops)
 * of a [Route]
 * defines an [OnClickListener] that returns the uuid and the [Coordinates] of the [Place]
...
class AdapterRouteStopsRecyclerView(private val routeStops: List<RouteNode>, var mode: String):
    ...
    private var onClickListener: AdapterRouteStopsRecyclerView.OnClickListener? = null
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): AdapterRouteStopsRecyclerView.ViewHolder {
    ...
    override fun onBindViewHolder(
        holder: AdapterRouteStopsRecyclerView.ViewHolder,
        position: Int
    ) {
