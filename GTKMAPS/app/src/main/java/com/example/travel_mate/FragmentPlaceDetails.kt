 ...
 * a [Fragment] to show important information about a [Place]
 */
class FragmentPlaceDetails : Fragment(){
     ...
     * [isContainedByTrip] tells if the specific place is contained by the [Trip] currently being planned
     * [isContainedByRoute] tells if the specific place is contained by the [Route] currently being planned
     */
            ...
            true -> {
                when(isContainedByRoute){
                    true -> {
                        ...
                        binding.placeAddRemoveRoute.icon = ContextCompat.getDrawable(requireContext(),R.drawable.ic_remove)
                    }
                    else -> {
                        binding.placeAddRemoveRoute.text = resources.getString(R.string.add_to_tour)
                        binding.placeAddRemoveRoute.icon = ContextCompat.getDrawable(requireContext(),R.drawable.ic_route_plan)
                    }
                }
            }
            else -> {
