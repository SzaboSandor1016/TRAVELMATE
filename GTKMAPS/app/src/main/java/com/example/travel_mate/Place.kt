 ...
 * It also serves as an [Entity] object for the [Room] local database
 *
 * It has may properties I'll better not list them.
 * All of them has [get] and [set] methods too
 */
...
data class Place(
    ...
    @Exclude
    @Ignore private var containedByRoute: Boolean = false) : java.io.Serializable {
